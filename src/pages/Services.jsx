  ...
  return (
    <div className="App-sub-container">
      <div className="this-container">
        ...
        <br />
        <div className="card">
          <Tabs defaultActiveKey="alarm" className="mb-3 card-header" justify>
            <Tab eventKey="alarm" title="Alarm systems" className="card-body">
              <h3>Alarm System Monitoring</h3>
              <br />
              <p>
                GPS Security Group is a certified alarm system monitoring
                company in Western Canada. We provide complete alarm monitoring
                services to our clients. It's essential to have quick and
                comprehensive communication between your security system,
                security provider, and law and enforcement authorities.
              </p>
              <br />
              <p>
                Our trained staff makes sure that proper authorities are alerted
                when an alarm is triggered at your property. Our comprehensive
                system sends alerts to the alarm owner as well. Through our
                services, you can have remote access to your security system at
                all times, and you can monitor your security cameras from your
                smartphone and other digital devices. The full features of our
                alarm monitoring system can be viewed below.
              </p>
              <br />
              <div className="card">
            ...
            >
              ...
              <p>
                ...
                commercial and industrial clients throughout Alberta, British
                Columbia, and Saskatchewan. The primary advantage of an online
                surveillance system like this is that it is operational around
                the clock. Our real-time video surveillance system allows a
                single person to man several screens simultaneously. This
                eliminates the need for deploying a security guard in every
                room, floor, or premise/location. You can catch an ongoing
                suspicious or criminal activity on your security camera and help
                investigation agencies find the culprits.
              </p>
              <br />
              ...
              <p>
                ...
                resulting in wasting crucial time on unnecessary investigations.
                False alarms can be caused by bugs, trees/leaves, shadows,
                reflections, lights, wind, and weather conditions. GPS Security
                Group uses Advanced AI technology to reduce the number of false
                alarms significantly. Our advanced AI cloud-based false alarm
                filtering technology reduces false alarms by up to 90%.
                <br />
                <br />
                GPS Security’s video monitoring software focuses on triggering
                true alarms. This includes real human activity, like identifying
                a person walking through a construction site, a man carrying a
                flashlight from a distance, vehicle movement on-site or within
                the area of interest, and additional related activities.
                <br />
                <br />
                Our video monitoring software also focuses on filtering out
                false alarms. This includes changing weather conditions, like
                lightning, animal activity, vehicle movement outside the area of
                interest, and other related activities.
              </p>
              <br />
              <div className="card">
                <div className="card-header">Quote</div>
            ...
            <Tab eventKey="tracking" title="Tracking" className="card-body">
              ...
              <p>
                ...
                The MSU Hybrid offers complete flexibility for temporary remote
                video surveillance. The unit is powered by solar panels for
                clean operation with an environmentally friendly diesel
                generator to recharge the batteries during cloudy or rainy days.
                <br />
                <br />
                Without refuelling, the unit can last for up to 4 months in the
                summer and up to 2 months in winter. It is easy to deploy and it
                is remotely monitored with IP HD cameras featuring up to 6
                months of localized recording and remote recording. With a
                combination of mobile patrols and mobile surveillance units, we
                can optimally deliver a wide range of security services.
              </p>
              <br />
              <div className="card">
                <div className="card-header">Quote</div>
